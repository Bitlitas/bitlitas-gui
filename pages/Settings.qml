...
*/
        ...
        TextBlock {
            ...
            property var txt: "<style type='text/css'>a {text-decoration: none; color: #499149}</style>" + qsTr("Wallet creation height: ") + currentWallet.walletCreationHeight + translationManager.emptyString
