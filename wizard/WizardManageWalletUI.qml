...
import QtQuick 2.2
import bitlitasComponents.TranslationManager 1.0
...
ColumnLayout {
    ...
    ColumnLayout {
        Label {
            ...
            Layout.topMargin: 20 * scaleRatio
            fontSize: 14
            text: qsTr("Your wallet is stored")+ translationManager.emptyString + ": " + fileUrlInput.text;
        }
