...
//    color: "#FFFFFF"
    ...
    function applySettings() {
        ...
        if(isIOS) {
            console.log("saving in ios: "+ bitlitasAccountsDir + new_wallet_filename)
            m_wallet.store(bitlitasAccountsDir + new_wallet_filename);
        } else {
...
//        Layout.bottomMargin: wizardBottomMargin
    ...
    Rectangle {
        ...
        radius: 25
        color: prevArea.containsMouse ? "#306d30" : "#499149"
    ...
    Rectangle {
        ...
        width: 50 * scaleRatio; height: 50 * scaleRatio
        radius: 25
        color: enabled ? nextArea.containsMouse ? "#306d30" : "#499149" : "#DBDBDB"
    ...
    StandardButton {
        ...
        text: qsTr("USE BITLITAS") + translationManager.emptyString
