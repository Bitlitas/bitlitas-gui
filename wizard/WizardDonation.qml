...
Item {
    ...
    Text {
        ...
        color: "#3F3F3F"
        text: qsTr("Bitlitas development is solely supported by donations") + translationManager.emptyString
    }
    ...
    Column {
        ...
        Text {
            ...
            text: qsTr("For every transaction, a small transaction fee is charged. This option lets you add an additional amount, " +
                       "as a percentage of that fee, to your transaction to support Bitlitas development. For instance, a 50% " +
                       "autodonation take a transaction fee of 0.005 XMR and add a 0.0025 XMR to support Bitlitas development.")
