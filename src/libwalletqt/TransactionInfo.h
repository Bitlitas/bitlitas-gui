...
public:
    enum Direction {
        Direction_In  =  Bitlitas::TransactionInfo::Direction_In,
        Direction_Out =  Bitlitas::TransactionInfo::Direction_Out,
...
private:
    explicit TransactionInfo(Bitlitas::TransactionInfo * pimpl, QObject *parent = 0);
private:
    friend class TransactionHistory;
    Bitlitas::TransactionInfo * m_pimpl;
