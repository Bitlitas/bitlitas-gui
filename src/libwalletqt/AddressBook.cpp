...
AddressBook::AddressBook(Bitlitas::AddressBook *abImpl,QObject *parent)
...
QList<Bitlitas::AddressBookRow*> AddressBook::getAll(bool update) const
{
    qDebug(__FUNCTION__);
...
Bitlitas::AddressBookRow * AddressBook::getRow(int index) const
{
