...
public:
    enum LogLevel {
        LogLevel_Silent = Bitlitas::WalletManagerFactory::LogLevel_Silent,
        LogLevel_0 = Bitlitas::WalletManagerFactory::LogLevel_0,
        LogLevel_1 = Bitlitas::WalletManagerFactory::LogLevel_1,
        LogLevel_2 = Bitlitas::WalletManagerFactory::LogLevel_2,
        LogLevel_3 = Bitlitas::WalletManagerFactory::LogLevel_3,
        LogLevel_4 = Bitlitas::WalletManagerFactory::LogLevel_4,
        LogLevel_Min = Bitlitas::WalletManagerFactory::LogLevel_Min,
        LogLevel_Max = Bitlitas::WalletManagerFactory::LogLevel_Max,
    };
...
private:
    ...
    Bitlitas::WalletManager * m_pimpl;
    QMutex m_mutex;
