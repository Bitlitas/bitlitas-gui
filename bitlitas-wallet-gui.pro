...
WALLET_ROOT=$$PWD/bitlitas

CONFIG += c++11

# cleaning "auto-generated" bitbitlitas directory on "make distclean"
...
linux {
   ...
   #     }
    ...
    # currently bitlitas has an issue with "static" build and linunwind-dev,
...
TRANSLATIONS =  \ # English is default language, no explicit translation file
                $$PWD/translations/bitlitas-core.ts \ # translation source (copy this file when creating a new translation)
                $$PWD/translations/bitlitas-core_lt.ts \ # Lithuania
...
android{
    deploy.commands += make install INSTALL_ROOT=$$DESTDIR && androiddeployqt --input android-libbitlitas-wallet-gui.so-deployment-settings.json --output $$DESTDIR --deployment bundled --android-platform android-21 --jdk /usr/lib/jvm/java-8-openjdk-amd64 -qmldir=$$PWD
}
...
DISTFILES += \
    notes.txt \
    bitlitas/src/wallet/CMakeLists.txt \
    components/MobileHeader.qml


# windows application icon
RC_FILE = bitlitas-core.rc
